...
class ExperimentConfig:
    ...
    target_coord_system: str # Whether target coordinates are in cartesian or polar coordinates.
    apply_activation: str # Whether to apply activation to the SUT outputs. ["none", "sigmoid", "softmax"]
    ...
    save_as: str = field(default="project_exp")  # The name identifier for saved experiment files.
